...
internal abstract partial class TextHelper
{
	...
	/// Singleton instance.
	/// </summary>
	public static readonly TextHelper Instance = SystemInfo.IsWindows ? new Windows() : new Unix();
	...
	public abstract ref NativeChar GetRef(TextParameter text, out Array? chars);
	/// <summary>
	...
	public abstract Int32 LoadArgsAddr(ArgumentsParameter args, Span<NativeCharPointer> addr, Span<ArgHandle> handles);
	/// <summary>
	...
	public abstract VolatileText CreateLiteral(NativeCharPointer charPointer);
	/// <summary>
	/// Cleans up the initialization memory.
	/// </summary>
	/// <param name="arrays">Arrays.</param>
	/// <param name="handles">Arguments handles.</param>
	public abstract void Clean(ReadOnlySpan<Array?> arrays, Span<ArgHandle> handles = default);
	/// <summary>
	...
	public abstract String GetString(ReadOnlySpan<NativeChar> chars);
